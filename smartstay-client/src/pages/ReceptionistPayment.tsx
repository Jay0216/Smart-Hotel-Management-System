...
import { simulatePayment, simulateReceptionistPayment } from "../redux/paymentSlice";
...
const ReceptionistPaymentPage: React.FC = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (simulateReceptionistPayment.fulfilled.match(action)) {
        setTimeout(() => {
...
export default ReceptionistPaymentPage;
